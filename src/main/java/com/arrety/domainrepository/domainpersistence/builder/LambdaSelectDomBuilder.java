...
import com.arrety.domainrepository.domainpersistence.domain.core.DomainFieldCache;
import com.arrety.domainrepository.domainpersistence.domain.core.DomainFieldUtil;
import com.arrety.domainrepository.domainpersistence.exception.ReflectionException;
import com.arrety.domainrepository.domainpersistence.interfaces.Func;
...
public class LambdaSelectDomBuilder extends AbstractWhereLambdaBuilder<LambdaSelectDomBuilder> implements Func<LambdaSelectDomBuilder> {
    ...
    public <T> LambdaSelectDomBuilder from(Class<T> clazz) {
        if (isSelectAll) {
            ...
            sql = new com.arrety.domainrepository.domainpersistence.common.StringBuilder(replaceAll);
        }
        sql.append(" from ")
    ...
    public void clear(){
        firstSet = true;
        sql = new com.arrety.domainrepository.domainpersistence.common.StringBuilder();
        sql.append(" select ");
